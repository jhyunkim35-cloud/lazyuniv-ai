...
**① 세션 시작:**
- `C:\Users\김준현\notyx-vault\10 Notyx\작업로그\_타임라인.md` 먼저 읽고 직전 맥락 복원. 디테일 필요하면 해당 작업로그 노트를 Grep로 핀포인트.
...
6. **옵시디언 즉시 기록** ← 제일 자주 까먹는 거. **라운드 끝 = 기록 끝.** `작업로그\YYYY-MM-DD 작업명.md`(뭘·어떻게·결과·커밋·교훈) + `_타임라인.md` 맨 위 한 줄.
