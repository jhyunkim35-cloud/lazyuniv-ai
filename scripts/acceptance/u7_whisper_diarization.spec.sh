...
assert_matches public/index.html "transcripts_view\.js\?v=(u7whisper|u8|u7bworker)" "U7-7: transcripts_view 캐시버스트 갱신"
...
assert_matches public/index.html "recorder\.js\?v=u7egroqprompt" "U7e-3: recorder.js 캐시버스트 갱신"
